...
public class OpenAiCompatibleLlmProvider implements LlmProvider {
    ...
    private static AiAnalysisException missingConfiguration(){return new AiAnalysisException("LLM configuration is missing. Configure config/fusiondesk.properties or LLM_API_KEY, LLM_BASE_URL and LLM_MODEL.");}
