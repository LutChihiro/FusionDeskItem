...
public final class Main {
    ...
    public static void main(String[] args) {
        ...
        try{database=DatabaseManager.defaultDatabase();database.initializeSchema();}catch(BusinessException e){System.err.println("Error: "+e.getMessage());System.exit(1);return;}
